-- Insert fathers
INSERT INTO fathers (first_name, church) VALUES ('angelos', 'malak');
INSERT INTO fathers (first_name, church) VALUES ('mina', 'mary');
...
(SELECT id FROM fathers WHERE first_name = 'angelos' and church = 'malak'));
...
(SELECT id FROM fathers WHERE first_name = 'mina' and church = 'mary'));
