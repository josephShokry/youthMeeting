...
public interface StreetMapper {
    ...
    Street getStreetFromDto(StreetDTO streetDTO, @MappingTarget Street street, @Context AreaService areaService);
    @AfterMapping
    default void attachArea(StreetDTO streetDTO, @MappingTarget Street street, @Context AreaService areaService){
        street.setArea(areaService.getById(streetDTO.areaId));
    }
